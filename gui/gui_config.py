...
CHOICES = {
    ...
    "vacancies.search_method": ["enumeration", "monte-carlo"],
    "vacancies.count_mode": ["all_reachable", "nominal"],
    "vacancies.enumeration_mode": ["auto", "exact", "sample"],
    "vacancies.mc_run_mode": ["fixed", "converged", "combined"],
    ...
    "vacancies.oxygen_reference_mode": [
        "global",
        "chemistry-specific",
        "reference_file",
        "same_calculator",
    ...
    "vacancies.oxygen_calibration_experimental_source": [
        "kingsbury",
        "kingsbury+custom",
        "custom",
    ],
